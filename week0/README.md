...
After verifying the simulation results, we will then move on to the layout design of the circuit. We first import arrange the transistors generated by **xschem**.

<p align="center">
  <img width=800 src="./images/fn_layout.jpg">
</p>

:underconstruction: Then we route connections in the design.

<p align="center">
  <img width=800 src="./images/fn_layout.jpg">
</p>

Alternatively, we can create the layout completely from the scratch using the standard paint feature in **Magic** as shown below.
