...
|:--:|:-------------------------:|:--------------------:|:-----:|
| 1  | [Inverter: generating GDS2 using ALIGN]()      | Creating GDS2 file from the spice netlist using ALIGN |:large_orange_diamond:|
| 2  | [Inverter: Post-layout simulation of ALIGN generated layout]()      | Extracting netlist and doing post-layout simulation |:large_orange_diamond:|
| 3  | [3. Comparision of pre-layout (xschem) and post-layout (Magic and ALIGN) outputs for Inverter]()      | Comparing the output waveform out of obtained from all three software |:large_orange_diamond:|
| 4  | [Fn: generating GDS2 using ALIGN]()      | Creating GDSII file from the spice netlist using ALIGN |:large_orange_diamond:|
